...
<html>
	<script type="text/javascript">
		function deleteByPid(pid){
			var result  =  confirm("您忍心删除我吗?");
			if(result){
				//请求服务器删除
				location.href = "${pageContext.request.contextPath}/cartServlet?method=deleteByPid&pid="+pid;
		...
		<div class="container">
			...
			<c:forEach items="${cart.values }" var="ci">
							<tr class="active">
								...
								<td width="10%">
									<input type="text" disabled="disabled" name="quantity" value="${ci.count }" maxlength="4" size="10">
								</td>
								<td width="15%">
