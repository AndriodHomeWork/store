...
<script type="text/javascript">
	...
	function fn1(obj) {
		//切换img中的图片,设置img的src
		obj.src = "${pageContext.request.contextPath}/userServlet?method=vcode&time="+new Date()
	}
</script>
...
<form class="form-horizontal" action="${pageContext.request.contextPath }/userServlet" method="post">
 ...
 <div class="form-group">
   ...
   <div class="form-group">
    ...
    <div class="col-sm-3">
      <img src="${pageContext.request.contextPath}/userServlet?method=vcode"  onclick="fn1(this)"/>
    </div>
   ...
   <div class="form-group">
    <div class="col-sm-offset-2 col-sm-10">
      <div class="checkbox">
        ...
        <label>
          <input type="checkbox" name="remeber" value="rem"> 记住用户名
        </label>
      </div>
    </div>
  </div>
  <div class="form-group">
	...
	<div style="margin-top:50px;">
		...
		<div style="text-align: center;margin-top: 5px;margin-bottom:20px;">
			Copyright &copy; 2016-2017 元元商城 版权所有
		</div>
</body></html>